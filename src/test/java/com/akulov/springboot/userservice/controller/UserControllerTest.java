...
class UserControllerTest {
    ...
    @Test
    void testGetAllUsersSuccessAndHaveLinks() throws Exception {
        ...
        mockMvc.perform(get("/api/users"))
                ...
                .andExpect(jsonPath("$._embedded.userDtoList[0]._links.allUsers.href").exists())
                .andExpect(jsonPath("$._links.self.href").exists())
                .andExpect(jsonPath("$._links.createUser.href").exists());
    }

    @Test
    void testGetUserByIdSuccessAndHaveLinks() throws Exception {
    ...
    void testUpdateUserSuccess() throws Exception {
        ...
        mockMvc.perform(put("/api/users/1")
                ...
                .andExpect(jsonPath("$.email").value("johnny.mnemonic@mail.com"));
    }
    ...
    @Test
    void testGetAllUsersByNameSuccessAndHaveLinks() throws Exception {
        ...
        mockMvc.perform(get("/api/users/name/John"))
                ...
                .andExpect(jsonPath("$._embedded.userDtoList[0]._links.self.href").exists())
                .andExpect(jsonPath("$._embedded.userDtoList[0]._links.allUsers.href").exists())
                .andExpect(jsonPath("$._embedded.userDtoList[0]._links.updateUser.href").exists())
                .andExpect(jsonPath("$._embedded.userDtoList[0]._links.deleteUser.href").exists())
                .andExpect(jsonPath("$._links.self.href").exists())
                .andExpect(jsonPath("$._links.allUsers.href").exists())
                .andExpect(jsonPath("$._links.createUser.href").exists());
    }
    ...
    void testLengthOfListWhenGetAllUsersByName() throws Exception {
        ...
        mockMvc.perform(get("/api/users/name/John"))
                ...
                .andExpect(jsonPath("$._embedded.userDtoList[0].name").value("John"))
                .andExpect(jsonPath("$._embedded.userDtoList[1].name").value("John"))
                .andExpect(jsonPath("$._embedded.userDtoList[0].email").value("john@example.com"))
                .andExpect(jsonPath("$._embedded.userDtoList[1].email").value("johnny@example.com"));
    }

    @Test
    void testEmptyListWhenGetAllUsersByName() throws Exception {
